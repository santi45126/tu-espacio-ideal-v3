const API_URL_COLLECTION = 'https://685c5401769de2bf085c6ec6.mockapi.io/departamentos'; // ¡URL base corregida a la colección directa!
...
async function loadDepartments(page = 1, userOnly = false) {
    currentPage = page;
    try {
        let url = `${API_URL_COLLECTION}?_page=${currentPage}&_limit=${itemsPerPage}`; 
