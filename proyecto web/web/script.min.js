...
authForm.addEventListener('submit', async (e) => {
    ...
    try {
        if (mode === 'register') {
            ...
            // Actualizar el perfil del usuario para guardar el nombre
...
// No necesitamos un DOMContentLoaded listener aquí, ya que onAuthStateChanged se dispara automáticamente
// al cargar la página y detecta si hay un usuario logueado, y luego llama a loadDepartments.