...
function displayDepartments(e){
    ...
    e.forEach(e=>{
        ...
        const highlightedDescription = highlightText(e.description, currentSearchTerm); // Aunque no se muestra, es útil si se añadiera después.
