...
async function loadDepartments(page = 1, userOnly = false) {
    ...
    try {
        ...
        // showToast('Error al cargar departamentos.', 'error'); // Esta línea ha sido eliminada.
    }
}
...
function updateUserUI() {
    if (currentUser) {
        ...
        // --- NUEVO: Mostrar el botón de cerrar sesión ---
        logoutButton.style.display = 'block'; 
        // --- FIN NUEVO ---
    } else {
        userActionButton.textContent = 'Iniciar Sesión / Registrarse';
        publishButton.style.display = 'none';
        // --- NUEVO: Ocultar el botón de cerrar sesión ---
...
authToggleLink.addEventListener('click', (e) => {
    ...
    if (authForm.dataset.mode === 'register') {
        ...
        authNameGroup.style.display = 'none';
        authToggleLink.textContent = '¿No tienes una cuenta? Inicia Sesión aquí.';
    } else {
        authForm.dataset.mode = 'register';
...
// --- NUEVO: Event Listener para el botón de cerrar sesión ---
